...
import { createOffer, initiateConnection, startCall, sendAnswer, addCandidate, initiateLocalStream, listenToConnectionEvents } from '../../extra/webrtc'
import firebase from 'firebase/app'
import 'firebase/database'
import { doOffer, doAnswer, doLogin, doCandidate } from '../../extra/firebaseModule'
      ...
      if (calls) {
        switch (calls.type) {
          case 'offer':
            ...
            listenToConnectionEvents(localConnection, username, calls.from, database, this.remoteVideoRef, doCandidate)

            sendAnswer(localConnection, localStream, calls, doAnswer, database, username)
            break
          case 'answer':
